...
### Plugin Settings ###
def ps(x):
	if (x=='_addon_id') or (x=='addon_id') or (x=='_plugin_id') or (x=='plugin_id'): return 'plugin.video.tbh.animeget'
	try: 
		return {
			'__plugin__': 					"A[COLOR white]nime[COLOR royalblue]Get[/COLOR][/COLOR]"
