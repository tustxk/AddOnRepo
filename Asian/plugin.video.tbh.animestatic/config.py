...
### Plugin Settings ###
def ps(x):
	if (x=='_addon_id') or (x=='addon_id') or (x=='_plugin_id') or (x=='plugin_id'): return 'plugin.video.tbh.animestatic'
	try: 
		return {
			'__plugin__': 					"A[COLOR white][COLOR blue]nime[/COLOR]Static[/COLOR]"
