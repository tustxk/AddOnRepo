"""
    Plugin for watching ABC News 24 Live Stream
"""
...
if ( __name__ == "__main__" ):
  ...
  rtmp_url="rtmp://cp81899.live.edgefcs.net/ app=live playpath=%s swfurl=http://www.abc.net.au/iview/images/iview.jpg swfvfy=true live=true" % stream
  item = xbmcgui.ListItem("ABC News 24", path=rtmp_url)
