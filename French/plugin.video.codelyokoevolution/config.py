...
def ps(x):
	return {
		'__plugin__': 					"[COLOR white][COLOR purple]C[/COLOR][COLOR cornflowerblue]o[/COLOR]de Ly[COLOR cornflowerblue]o[/COLOR]k[COLOR cornflowerblue]o[/COLOR] Ev[COLOR cornflowerblue]o[/COLOR]luti[COLOR cornflowerblue]o[/COLOR]n[/COLOR]"
		,'__authors__': 				"[COLOR white]The[COLOR tan]Highway[/COLOR][/COLOR]"
		,'__credits__': 				"TheHighway of plugin.video.theanimehighway for teh_tools.py"
		,'_addon_id': 					"plugin.video.codelyokoevolution"
		,'_plugin_id': 					"plugin.video.codelyokoevolution"
		,'_domain_url': 				"http://codelyokoevolutionfan.webs.com/"
		,'_domain_url_cat': 		"http://codelyokoevolutionfan.webs.com/apps/videos/"
		,'_database_name': 			"codelyokoevolution"
		,'_addon_path_art': 		"art"
		...
		,'cFL_color4': 					'grey'
		,'cFL_color5': 					'white'
		,'cFL_color6': 					'cornflowerblue'
		,'default_section': 		'movies'
		,'section.movie': 			'movies'
		,'section.tv': 					'tv'
		,'video.generic':				'http://images.freewebs.com/Images/no_vid_generic.gif'
