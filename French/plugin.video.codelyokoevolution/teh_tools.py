...
def addLink(name,url,iconimage=ICON,fanimage=fanart,shoname='none',downloadable=True):
        ...
        #
        #
        _addon.add_directory({'mode': 'DoVideo','url':url,'title':addpr('title',''),'studio': name },{'title': name, 'Studio': shoname, 'image': iconimage } ,is_folder=False		,img=iconimage,fanart=fanimage)
        return
        #
        #
        #
