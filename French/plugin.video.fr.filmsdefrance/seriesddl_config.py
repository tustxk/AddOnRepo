...
def ps(x):
	...
	try: 
		return {
			...
			,'MyGenres':						[ ['complete','Complete','Complete'],['action','Action','Action'],['aventure','Aventure','Adventure'],['comedie','Comedie','Comedy'],['crime','Crime','Crime'],['drame','Drame','Drama'],['episode-01','1st Episode','1st Episode'],['french','French','French'],['francais','Francais','France'],['policier','Policier','Police'],['science-fiction','Science-Fiction','Sci-Fi'],['romance','Romance','Romance'],['saison-01','1st Saison','1st Season'],['saison-02','2nd Saison','2nd Season'],['saison-03','3rd Saison','3rd Season'],['saison-04','4th Saison','4th Season'],['saison-05','5th Saison','5th Season'],['saison-06','6th Saison','6th Season'],['saison-07','7th Saison','7th Season'],['saison-08','8th Saison','8th Season'] ]
			## ['anciens','Anciens','Veterans'],['animation','Animation','Animation'],['arts-martiaux','Arts Martiaux','Martial Arts'],['biopic','Biopic','Biopic'],['comedie-dramatique','Comedie Dramatique','Comedy Drama'],['comedie-musicale','Comedie musicale','Music Comedy'],['comics','Comics','Comics'],['dessin-anime-et-jeunesse','Dessin anime','Cartoons'],['documentaire','Documentaire','Documentary'],['fantastique','Fantastique','Fantasy'],['guerre','Guerre','War'],['historique','Historique','History'],['peplum','Peplum','Peplum'],['thriller','Thriller','Thriller'],['horreur-frisson','Horreur-frisson','Horror Thriller'],['version-original','Version original','Original Version'],['western','Western','Western'],['spectacles-sketchs','Spectacles Sketchs','Entertainment Sketches'],['drame','Drame','Drama'],['famille','Famille','Family']
			# ,['u','f','e']
