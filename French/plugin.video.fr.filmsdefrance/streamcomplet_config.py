...
def ps(x):
	...
	try: 
		return {
			'__plugin__': 					"Stream Complet"
			,'__authors__': 				"[COLOR white]The[COLOR tan]Highway[/COLOR][/COLOR]"
			,'__credits__': 				""
			,'_domain_url': 				""
			,'UsedLanguages':				['French','English']
			,'mainSite': 						'http://streamcomplet.com'
			,'mainSite2': 					'http://www.streamcomplet.com'
			,'colorA': 							"FFF7FF43"
			,'colorB': 							"FFD0FF04" #'FFB7C411'
			...
			,'MyGenres':						[ ['action','Action','Action'],['thriller','Thriller','Thriller'],['drame','Drame','Drama'],['comedie','Comedie','Comedy'],['animation','Animation','Animation'],['policier','Policier','Police'],['fiction','Fiction','Fiction'],['horreur','Horreur','Horror'],['historique','Historique','Historical'],['guerre','Guerre','War'],['aventure','Aventure','Adventure'],['musique','Musique','Music'],['romance','Romance','Romance'] ]
			# ,['u','f','e']
