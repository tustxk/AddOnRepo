...
class Filehoot(HostResolver, CustomSettings):
    ...
    def Resolve(self, url):
        ...
        try:
            ...
            postdata['method_free']='Watch Now'

            html = net.http_POST(url,postdata).content

            r = re.search(r'ashvars\'\svalue=\'file=(.*?)\&',html,re.I)
