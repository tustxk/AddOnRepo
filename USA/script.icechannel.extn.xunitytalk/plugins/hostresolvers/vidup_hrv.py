...
class Vidup(HostResolver, CustomSettings):
    ...
    def Resolve(self, url):
        ...
        try:
            ...
            if items:
                ...
                pattern='javascript\'\>(eval\(function\(p\,a\,c\,k\,e\,d\).*?\)\)\))'
                r=re.search(r''+pattern+'',html,re.I)
                unpacked=jsunpack.unpack(r.group(1))

                final_Link=re.search(r'file\:\"(.*?)\"',unpacked,re.I)
                if final_Link:
