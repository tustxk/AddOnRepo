...
class Vshare(HostResolver, CustomSettings):
    ...
    def Resolve(self, url):
        ...
        try:
            ...
            postdata['method_free']='Proceed to video'

            html = net.http_POST(url,postdata).content

            r = re.search(r'config\:\{file\:\'(.*?)\'',html, re.I)
