...
class directdownload(TVShowSource,CustomSettings):
    ...
    def GetFileHostsForContent(self, title, name, year, season, episode, type, list, lock, message_queue):                 
        ...
        searchUrl='http://directdownload.tv/index/search/keyword/%s s%se%s/qualities/pdtv,dsr,hdtv,realhd,dvdrip,webdl,webdl1080p/from/0/search' %(name.lower(),season_pull,episode_pull)        
