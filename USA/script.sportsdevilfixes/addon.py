...
import urllib,urllib2,re,xbmcplugin,xbmcgui,sys,xbmc,xbmcaddon,xbmcvfs,os,json,datetime,shutil
...
def copy(last_commit):
	...
	recursive_overwrite(fromDirectory, toDirectory, ignore=None)
